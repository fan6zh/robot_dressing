...
sys.path.append('/home/fanfan/Documents/gsrobotics')
import copy
import cv2
import os
...
if __name__ == '__main__':
    ...
    for i in range(NUM_SENSORS):
        ...
        gs['vs'][i] = WebcamVideoStream(
            src=2 * i + idd).start()  # make sure the id numbers of the cameras are ones recognized by the computer. Default, 2 and 4
