...
class MoveRidgeback(object):
    ...
    def check_states(self):
        ...
        while not rospy.is_shutdown() and self.state != 2:
            ...
            goal_pick.target_pose.pose.position.x = 3.38760635592
            goal_pick.target_pose.pose.position.y = 0.488272805875
            goal_pick.target_pose.pose.position.z = 0.0
            goal_pick.target_pose.pose.orientation.x = 0.0
            goal_pick.target_pose.pose.orientation.y = 0.0
            goal_pick.target_pose.pose.orientation.z = -0.102637065415
            goal_pick.target_pose.pose.orientation.w = 0.994718871241
